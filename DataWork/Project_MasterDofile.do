...
*iefolder*1*RoundGlobals*rounds*Consommation*Consommation***********************
*iefolder will not work properly if the line above is edited

   *Consommation folder globals
...
*iefolder*3*RunDofiles*Consommation*Consommation********************************
*iefolder will not work properly if the line above is edited

   if (0) { //Change the 0 to 1 to run the Consommation master dofile
       do "$Consommation/Consommation_MasterDofile.do" 
   }
